...
SELECT o.first_name, o.last_name, COUNT(*) AS vehicle_count FROM owners o JOIN vehicles v ON o.id = v.owner_id GROUP BY o.first_name, o.last_name ORDER BY o.first_name ASC;
...
SELECT o.first_name, o.last_name, CEIL(AVG(v.price)) AS average_price, COUNT(*) FROM owners o JOIN vehicles v ON o.id = v.owner_id GROUP BY o.first_name, o.last_name HAVING COUNT(*) > 1 AND CEIL(AVG(v.price)) > 10000 ORDER BY o.first_name DESC;
